...
This is a web application that consists of a math quiz that creates randomly generated questions with the option of selecting different arithmetic problems such as,
addition, subtraction, and multiplication. This application requires users to create an account which then allows users to save their scores in a public leaderboard.
A search function allows users to search for other users, follow them, and view their profile.
...
the user sees by default is the login page, a login is required in order to access the rest of the application features. Once logged in you are automatically directed
...
the question.js file is the most complex js file in the application. It consists of separate javascript as well two individual functions that are called repeatedly.
First:
...
Once ten questions have been answered, you are automatically redirected to an end page. The end page gives you the option of saving the score to an SQLAlchemy table, or
...
In the question.js file, after an index has been determined the arithmetic operator is set and displayed on the html page, two subject variables num1, and num2 are randomly generated, and a "solution" variable is declared.
